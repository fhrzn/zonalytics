...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/style-dashboard.css')); ?>">
    <!-- MDB icon -->
    <link rel="icon" href="<?php echo e(asset('mdb-favicon.ico')); ?>" type="image/x-icon">
    <!-- Font Awesome -->
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <?php if(Auth::check()): ?>
                            <a class="nav-item nav-link" href="<?php echo e(route('admin.dashboard')); ?>" id="menu-login">Dashboard</a>
                        <?php else: ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="<?php echo e(route('login')); ?>" onsubmit="doLogin(event)">
...
</html><?php /**PATH E:\myproject\SKRIPSI\frontend\zonalytics\resources\views/index.blade.php ENDPATH**/ ?>